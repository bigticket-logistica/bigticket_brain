...
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBzdmR0Z2p2b2duYm14ZnZxYmFhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIwMzAwMTQsImV4cCI6MjA4NzYwNjAxNH0.zEBcFOT8u9BViQ1YVMm-QYsPKy1TZCKU2nJXqJR1Em0";
const sb = createClient(SUPABASE_URL, SUPABASE_KEY);
const PIPE_ID = "306833898";
const BIGGY_IMG = "data:image/jpeg;base64,";

const MODULOS = {
  superadmin: ["brain", "prospeccion", "certificaciones", "pagos", "wiki", "checklist", "kpis", "maestro", "incidencias", "pnr", "drivers", "config_pagos", "configuracion"],
...
const PlantillasView = () => {
  ...
  const fetchPlantillas = async () => {
    setLoading(true);
    const data = await lfSb.from("plantillas").select("*", { order:"created_at.asc" });
  ...
  const guardar = async () => {
    ...
    try {
      if (editando) {
        await lfSb.from("plantillas").update({ ...form, updated_at: new Date().toISOString() }, `id=eq.${editando.id}`);
      } else {
        await lfSb.from("plantillas").insert({ ...form });
      }
  ...
  const eliminar = async (id) => {
    ...
    await lfSb.from("plantillas").delete(`id=eq.${id}`);
    await fetchPlantillas();
  };

  const toggleActiva = async (p) => {
    await lfSb.from("plantillas").update({ activa:!p.activa }, `id=eq.${p.id}`);
    await fetchPlantillas();
  };
...
const ConfigScoreView = () => {
  ...
  const fetchDimensiones = async () => {
    setLoading(true);
    const data = await lfSb.from("config_score").select("*", { order:"orden.asc" });
  ...
  const guardarReglas = async (dim, nuevasReglas) => {
    setSaving(true);
    try {
      await lfSb.from("config_score").update({ reglas:nuevasReglas, updated_at:new Date().toISOString() }, `id=eq.${dim.id}`);
  ...
  const toggleDim = async (dim) => {
    await lfSb.from("config_score").update({ activa:!dim.activa }, `id=eq.${dim.id}`);
    await fetchDimensiones();
  };
  ...
  const eliminarDim = async (id) => {
    ...
    await lfSb.from("config_score").delete(`id=eq.${id}`);
    await fetchDimensiones();
  };
  ...
  const guardarDim = async () => {
    ...
    try {
      ...
      if (editandoDim) {
        await lfSb.from("config_score").update({ nombre:formDim.nombre, descripcion:formDim.descripcion, updated_at:new Date().toISOString() }, `id=eq.${editandoDim.id}`);
      } else {
        await lfSb.from("config_score").insert({ dimension:formDim.dimension||formDim.nombre.toLowerCase().replace(/\s+/g,"_"), nombre:formDim.nombre, descripcion:formDim.descripcion, orden, reglas:[], activa:true });
      }
      await fetchDimensiones();
      setModalDim(false);
    } finally { setSaving(false); }
...
const TimelineView = ({ lead }) => {
  ...
  useEffect(()=>{
    const fetch=async()=>{
      const data=await lfSb.from("lead_historial").select("*",{filter:`lead_id=eq.${lead.id}`,order:"created_at.asc"});
...
function LogiFlowApp() {
  ...
  const fetchLeads=async()=>{
    const norm=(e)=>{if(!e)return"Nuevo Lead";const m={"nuevo lead":"Nuevo Lead","nuevo":"Nuevo Lead","new":"Nuevo Lead","postulante":"Nuevo Lead","contactado":"Base Datos Leads","reunión agendada":"Base Datos Leads","reunion agendada":"Base Datos Leads","negociación":"Base Datos Leads","negociacion":"Base Datos Leads","propuesta enviada":"Propuesta Enviada","propuesta aceptada":"Propuesta Aceptada","propuesta rechazada":"Propuesta Rechazada","contrato firmado":"Postulante Aprobado","contrato no firmado":"Postulante No Calificado","ganado":"Postulante Aprobado","perdido":"Postulante No Calificado","postulante aprobado":"Postulante Aprobado","postulante no calificado":"Postulante No Calificado","entrevistas y validaciones":"Entrevistas y Validaciones","base datos leads":"Base Datos Leads"};return m[e.toLowerCase().trim()]||e;};
    try{const data=await lfSb.from("leads").select("*",{order:"created_at.desc"});
  ...
  const confirmarCambioEtapa=async()=>{
    ...
    try{
      await lfSb.from("leads").update({etapa:nuevaEtapa},`id=eq.${lead.id}`);
      await lfSb.from("lead_historial").insert({lead_id:lead.id,etapa_anterior:etapaActual,etapa_nueva:nuevaEtapa});
...
function ModuloPNR() {
  ...
  const estadoColor = {
    ...
    "Con penalidad":           { bg: "#fee2e2", color: "#c0392b" },
  };
    ...
    <div className="pg">
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:20, flexWrap:"wrap", gap:12 }}>
        <div>
          ...
          <div style={{ fontSize:12, color:"#888", marginTop:2 }}>Reclamos de período de facturación</div>
        </div>
        <div style={{ display:"flex", gap:8, alignItems:"center" }}>
          ...
          <button onClick={() => cargarCasos(periodo)} style={{ fontSize:12, padding:"6px 14px", borderRadius:8, border:"1px solid #e4e7ec", background:"#fff", cursor:"pointer", fontFamily:"'Outfit', sans-serif" }}>🔄 Actualizar</button>
        </div>
      </div>
      ...
      <div className="three-col" style={{ marginBottom:20 }}>
        ...
        <div className="form-card" style={{ textAlign:"center", padding:"16px 12px" }}>
          <div style={{ fontSize:36, fontWeight:800, color:"#92400e" }}>{casos.filter(c => c.estado === "Pendiente de revision").length}</div>
          <div style={{ fontSize:11, color:"#888", fontWeight:600, textTransform:"uppercase", letterSpacing:1 }}>Pendientes Revisión</div>
        </div>
      </div>
        ...
        <div>
          ...
          <div style={{ background:"#fff", borderRadius:10, border:"1px solid #e4e7ec", overflow:"auto" }}>
            <table style={{ width:"100%", borderCollapse:"collapse", fontSize:12 }}>
              <thead>
                <tr style={{ background:"#f8f9fa" }}>
                  {["ID Caso","Fecha","Estado","Ruta","S/O","Conductor","Productos","Valor","Sync"].map(h => (
                    <th key={h} style={{ padding:"10px 12px", textAlign:"left", fontWeight:700, color:"#555", borderBottom:"1px solid #e4e7ec", whiteSpace:"nowrap" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {casosFiltrados.length === 0 ? (
                  <tr><td colSpan={9} style={{ padding:"30px", textAlign:"center", color:"#888" }}>Sin resultados</td></tr>
                  ...
                  return (
                    <tr key={c.id||i} style={{ borderBottom:"1px solid #f4f5f7" }}>
                      ...
                      <td style={{ padding:"9px 12px", color:"#555", whiteSpace:"nowrap" }}>{c.fecha_caso ? new Date(c.fecha_caso).toLocaleDateString("es-MX",{day:"2-digit",month:"short"}) : "—"}</td>
                      <td style={{ padding:"9px 12px" }}><span style={{ ...estilo, padding:"3px 10px", borderRadius:20, fontSize:11, fontWeight:700, whiteSpace:"nowrap" }}>{c.estado||"—"}</span></td>
                      <td style={{ padding:"9px 12px", color:"#555" }}>{c.ruta||"—"}</td>
                      <td style={{ padding:"9px 12px", color:"#555" }}>{c.estacion_origen||"—"}</td>
                      <td style={{ padding:"9px 12px", color:"#555" }}>{c.id_conductor||"—"}</td>
                      <td style={{ padding:"9px 12px", color:"#444", maxWidth:200, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{c.productos||"—"}</td>
                      <td style={{ padding:"9px 12px", fontWeight:700, color:"#1a3a6b", whiteSpace:"nowrap" }}>{c.valor_compra ? `$${c.valor_compra.toLocaleString("es-MX")}` : "—"}</td>
                      <td style={{ padding:"9px 12px", color:"#888", whiteSpace:"nowrap" }}>{c.ultima_sync ? new Date(c.ultima_sync).toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"}) : "—"}</td>
                    </tr>
                  );
                })}
              </tbody>
      ...
      {tabPnr === "resumen" && (
        <div className="form-card">
          <div className="form-title">Distribución por Estado</div>
          {porEstado.map((e, i) => {
            const estilo = getEstilo(e.estado);
            const pct = casos.length ? Math.round(e.cantidad / casos.length * 100) : 0;
            return (
              <div key={i} style={{ marginBottom:16 }}>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
                  <span style={{ ...estilo, padding:"3px 12px", borderRadius:20, fontSize:12, fontWeight:700 }}>{e.estado}</span>
                  <div style={{ textAlign:"right" }}>
                    <span style={{ fontWeight:700, color:"#1a3a6b", fontSize:13 }}>{e.cantidad} casos</span>
                    <span style={{ color:"#888", fontSize:12, marginLeft:8 }}>${e.valor.toLocaleString("es-MX")}</span>
                  </div>
                </div>
                <div style={{ background:"#f1f5f9", borderRadius:8, height:8, overflow:"hidden" }}>
                  <div style={{ background:estilo.color, height:"100%", width:`${pct}%`, borderRadius:8 }} />
                </div>
                <div style={{ fontSize:11, color:"#888", marginTop:3 }}>{pct}% del total</div>
              </div>
            );
          })}
        </div>
      ...
      {tabPnr === "rutas" && (
        <div style={{ background:"#fff", borderRadius:10, border:"1px solid #e4e7ec", overflow:"auto" }}>
          <table style={{ width:"100%", borderCollapse:"collapse", fontSize:12 }}>
            <thead>
              <tr style={{ background:"#f8f9fa" }}>
                {["Ruta","Estación","Casos","Valor Total","Pendientes","Anulados"].map(h => (
                  <th key={h} style={{ padding:"10px 12px", textAlign:"left", fontWeight:700, color:"#555", borderBottom:"1px solid #e4e7ec" }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {Object.entries(casos.reduce((acc, c) => {
                const k = c.ruta || "Sin ruta";
                if (!acc[k]) acc[k] = { ruta:k, estacion:c.estacion_origen, casos:0, valor:0, pendientes:0, anulados:0 };
                acc[k].casos++; acc[k].valor += c.valor_compra||0;
                if (c.estado === "Pendiente de revision") acc[k].pendientes++;
                if (c.estado === "Anulado") acc[k].anulados++;
                return acc;
                ...
                <tr key={i} style={{ borderBottom:"1px solid #f4f5f7" }}>
                  ...
                  <td style={{ padding:"9px 12px", color:"#555" }}>{r.estacion||"—"}</td>
                  <td style={{ padding:"9px 12px", fontWeight:700 }}>{r.casos}</td>
                  <td style={{ padding:"9px 12px", color:"#1a3a6b", fontWeight:700 }}>${r.valor.toLocaleString("es-MX")}</td>
                  <td style={{ padding:"9px 12px" }}>{r.pendientes > 0 ? <span style={{ background:"#f3e8ff", color:"#6b21a8", padding:"2px 10px", borderRadius:20, fontWeight:700 }}>{r.pendientes}</span> : "—"}</td>
                  <td style={{ padding:"9px 12px", color:"#888" }}>{r.anulados||"—"}</td>
                </tr>
              ))}
            </tbody>
          </table>
...
// ─── MÓDULO BRAIN CENTRAL ───────────────────────────────────────────
// Vista panorámica con cerebro central + módulos orbitales con datos en vivo.
// Click en cualquier módulo navega a esa pestaña.
function BrainCentral({ setTab, usuario }) {
  const [stats, setStats] = useState({
    pagos: { value: "—", subtitle: "cargando", severity: "info", target: "pagos" },
    prospeccion: { value: "—", subtitle: "cargando", severity: "info", target: "prospeccion" },
    incidencias: { value: "—", subtitle: "cargando", severity: "info", target: "incidencias" },
    drivers: { value: "—", subtitle: "cargando", severity: "info", target: "drivers" },
    pnr: { value: "—", subtitle: "cargando", severity: "info", target: "pnr" },
    wiki: { value: "—", subtitle: "cargando", severity: "info", target: "wiki" },
  });
  const [loading, setLoading] = useState(true);
  ...
  const cargarEstadisticas = async () => {
    setLoading(true);
    const nuevoStats = { ...stats };

    try {
      // PAGOS: empresas activas con retención (críticas)
      const ahora = new Date();
      const anio = ahora.getFullYear();
      const mes = ahora.getMonth() + 1;
      const { data: pagos } = await sb.from("certronic_certificacion_mensual")
        .select("transporte, pct_retencion, recurso_inhabilitado, empleados_activos, vehiculos_activos")
        .eq("anio", anio).eq("mes", mes);
      if (pagos) {
        const criticos = pagos.filter(p => 
          !p.recurso_inhabilitado && Number(p.pct_retencion) > 0 &&
          ((p.empleados_activos || 0) > 0 || (p.vehiculos_activos || 0) > 0)
        );
        const empresasCriticas = new Set(criticos.map(c => c.transporte)).size;
        nuevoStats.pagos = {
          value: empresasCriticas,
          subtitle: empresasCriticas === 1 ? "empresa crítica" : "empresas críticas",
          severity: empresasCriticas > 20 ? "high" : empresasCriticas > 5 ? "warn" : empresasCriticas > 0 ? "info" : "ok",
          target: "pagos",
        };
      }
      ...
      // ÚLTIMA EJECUCIÓN
      const { data: log } = await sb.from("certronic_ejecuciones_log")
        .select("fecha_ejecucion").order("fecha_ejecucion", { ascending: false }).limit(1);
      if (log && log[0]) setUltimaActualizacion(log[0].fecha_ejecucion);

      // PROSPECCIÓN: leads recientes (últimos 7 días) - tabla "leads"
      try {
        ...
        nuevoStats.prospeccion = {
          value: leadsCount ?? 0,
          subtitle: "leads última semana",
          severity: (leadsCount ?? 0) > 0 ? "info" : "ok",
          target: "prospeccion",
        };
      } catch {
        nuevoStats.prospeccion = { value: "—", subtitle: "sin acceso", severity: "info", target: "prospeccion" };
      }

      // INCIDENCIAS: casos abiertos
      try {
        const { count: incCount } = await sb.from("incidencias_lastmile")
          .select("*", { count: "exact", head: true })
          .eq("estado", "ABIERTO");
        nuevoStats.incidencias = {
          value: incCount ?? 0,
          subtitle: incCount === 1 ? "caso abierto" : "casos abiertos",
          severity: (incCount ?? 0) > 5 ? "high" : (incCount ?? 0) > 0 ? "warn" : "ok",
          target: "incidencias",
        };
      } catch {
        nuevoStats.incidencias = { value: "—", subtitle: "sin acceso", severity: "info", target: "incidencias" };
      }

      // DRIVERS MX: certificados activos
      try {
        const { count: driversCount } = await sb.from("certificaciones_mx")
          .select("*", { count: "exact", head: true })
          .eq("estado", "APROBADO");
        nuevoStats.drivers = {
          value: driversCount ?? 0,
          subtitle: "drivers certificados",
          severity: "ok",
          target: "drivers",
        };
      } catch {
        nuevoStats.drivers = { value: "—", subtitle: "sin acceso", severity: "info", target: "drivers" };
      }

      // PNR: casos pendientes
      try {
        const { count: pnrCount } = await sb.from("pnr_casos")
          .select("*", { count: "exact", head: true })
          .eq("estado", "PENDIENTE");
        nuevoStats.pnr = {
          value: pnrCount ?? 0,
          subtitle: pnrCount === 1 ? "caso pendiente" : "casos pendientes",
          severity: (pnrCount ?? 0) > 5 ? "warn" : (pnrCount ?? 0) > 0 ? "info" : "ok",
          target: "pnr",
        };
      } catch {
        nuevoStats.pnr = { value: "—", subtitle: "sin acceso", severity: "info", target: "pnr" };
      }

      // WIKI: total artículos
      try {
        const { count: wikiCount } = await sb.from("wiki_articulos")
          .select("*", { count: "exact", head: true });
        nuevoStats.wiki = {
          value: wikiCount ?? 0,
          subtitle: "artículos",
        ...
        nuevoStats.wiki = { value: "—", subtitle: "sin acceso", severity: "info", target: "wiki" };
      }
  ...
  const modulos = [
    { id: "pagos", label: "Pagos CL", angle: 270, ...stats.pagos },
    { id: "prospeccion", label: "Prospección", angle: 330, ...stats.prospeccion },
    { id: "incidencias", label: "Incidencias", angle: 30, ...stats.incidencias },
    { id: "drivers", label: "Drivers MX", angle: 90, ...stats.drivers },
    { id: "pnr", label: "PNR", angle: 150, ...stats.pnr },
    { id: "wiki", label: "Wiki", angle: 210, ...stats.wiki },
  ];

  // Colores por severidad (corporativos Bigticket)
  const colorSeverity = {
    high: "#c0392b",      // rojo crítico
    warn: "#F47B20",      // naranja Bigticket
    ok: "#16a34a",        // verde
    info: "#1a3a6b",      // azul Bigticket
  };

  // Geometría
  const cx = 400, cy = 280, brainR = 80, nodeOrbit = 200, nodeR = 56;
  ...
  return (
    <div className="pg" style={{ paddingBottom: 40 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 18, flexWrap: "wrap", gap: 12 }}>
        <div>
          <div className="sec-title">Brain Central</div>
          <div className="sec-sub">
            Bienvenido{usuario?.nombre ? `, ${usuario.nombre.split(" ")[0]}` : ""} · Vista panorámica del sistema
            {ultimaActualizacion && (
              <> · Última actualización: {new Date(ultimaActualizacion).toLocaleString("es-CL", { day: "2-digit", month: "short", hour: "2-digit", minute: "2-digit" })}</>
            )}
          </div>
        </div>
        <button onClick={cargarEstadisticas} disabled={loading}
          style={{ padding: "8px 14px", background: "#fff", border: "1px solid #cbd5e1", borderRadius: 6, fontSize: 12, fontWeight: 600, cursor: "pointer", color: "#475569", fontFamily: "Geist, sans-serif" }}>
      ...
      <div style={{
        ...
        <svg viewBox="0 0 800 560" style={{ width: "100%", maxWidth: 900, display: "block", margin: "0 auto" }}>
          <defs>
            {/* Gradiente sutil para el cerebro central */}
            <radialGradient id="brainGradient" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="#2a4a7b" />
            ...
            <style>{`
              ...
              .node-group:hover { opacity: 0.75; }
              .node-group:hover circle { stroke-width: 2.5; }
            `}</style>
          </defs>

          {/* Líneas (nervios) entre cerebro y nodos */}
          {modulos.map(m => {
            const rad = (m.angle * Math.PI) / 180;
            const startX = cx + Math.cos(rad) * brainR;
            const startY = cy + Math.sin(rad) * brainR;
            const endX = cx + Math.cos(rad) * (nodeOrbit - nodeR);
            const endY = cy + Math.sin(rad) * (nodeOrbit - nodeR);
            const midX = (startX + endX) / 2;
            const midY = (startY + endY) / 2;
            const perpAngle = rad + Math.PI / 2;
            const ctrlOffset = 15;
            const ctrlX = midX + Math.cos(perpAngle) * ctrlOffset;
            const ctrlY = midY + Math.sin(perpAngle) * ctrlOffset;
            const path = `M${startX} ${startY} Q${ctrlX} ${ctrlY} ${endX} ${endY}`;
            const color = colorSeverity[m.severity] || "#1a3a6b";
            const isActive = m.severity === "high" || m.severity === "warn";
            return (
              <g key={`line-${m.id}`}>
                <path d={path} fill="none" stroke={color} strokeWidth={isActive ? 1.5 : 1} opacity={isActive ? 0.6 : 0.25} />
                {isActive && (
                  <path d={path} fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" className="nerve-line" opacity="0.8"/>
                )}
              </g>
            );
          })}

          {/* Anillos pulsantes externos del cerebro */}
          <circle cx={cx} cy={cy} r={brainR + 8} fill="none" stroke="#1a3a6b" strokeWidth="0.5" opacity="0.2" className="brain-ring" />
          
          {/* Cerebro central */}
          <g className="brain-core-circle">
            <circle cx={cx} cy={cy} r={brainR} fill="url(#brainGradient)" stroke="#1a3a6b" strokeWidth="2" />
            <text x={cx} y={cy - 8} textAnchor="middle" fill="#fff" style={{ fontSize: 22, fontWeight: 700, fontFamily: "Geist, sans-serif", letterSpacing: 1 }}>BRAIN</text>
            <text x={cx} y={cy + 14} textAnchor="middle" fill="#F47B20" style={{ fontSize: 11, fontWeight: 600, fontFamily: "Geist, sans-serif", letterSpacing: 0.5 }}>BIGTICKET</text>
          </g>

          {/* Nodos de módulos */}
          {modulos.map(m => {
            const rad = (m.angle * Math.PI) / 180;
            const nx = cx + Math.cos(rad) * nodeOrbit;
            const ny = cy + Math.sin(rad) * nodeOrbit;
            const color = colorSeverity[m.severity] || "#1a3a6b";
            return (
              <g key={m.id} className="node-group" onClick={() => setTab(m.target)}>
                <circle cx={nx} cy={ny} r={nodeR} fill="#fff" stroke={color} strokeWidth="1.5" />
                <text x={nx} y={ny - 14} textAnchor="middle" fill="#475569" style={{ fontSize: 11, fontWeight: 600, fontFamily: "Geist, sans-serif" }}>{m.label}</text>
                <text x={nx} y={ny + 10} textAnchor="middle" fill={color} style={{ fontSize: 24, fontWeight: 700, fontFamily: "Geist, sans-serif" }}>{m.value}</text>
                <text x={nx} y={ny + 26} textAnchor="middle" fill="#94a3b8" style={{ fontSize: 9, fontWeight: 500, fontFamily: "Geist, sans-serif" }}>{m.subtitle}</text>
              </g>
            );
          })}
        </svg>
        ...
        {/* Leyenda inferior */}
        <div style={{ display: "flex", gap: 16, justifyContent: "center", marginTop: 10, fontSize: 10, color: "#64748b", flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#c0392b", display: "inline-block" }}></span>
            Crítico
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#F47B20", display: "inline-block" }}></span>
            Atención
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#1a3a6b", display: "inline-block" }}></span>
            Informativo
          </div>
          <div style={{ marginLeft: 16, fontStyle: "italic", color: "#94a3b8" }}>
            Click en cualquier módulo para entrar
          </div>
        </div>
      </div>

      {/* Resumen rápido debajo */}
      <div style={{ marginTop: 16, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 10 }}>
        {modulos.filter(m => m.severity === "high" || m.severity === "warn").map(m => (
          <div key={`alert-${m.id}`} 
            onClick={() => setTab(m.target)}
            style={{
              background: "#fff",
              border: "1px solid #e4e7ec",
              borderLeft: `3px solid ${colorSeverity[m.severity]}`,
              borderRadius: 6,
              padding: "10px 12px",
              cursor: "pointer",
      ...
      {modulos.filter(m => m.severity === "high" || m.severity === "warn").length === 0 && !loading && (
        <div style={{ marginTop: 16, padding: "14px", background: "#f0fdf4", border: "1px solid #86efac", borderRadius: 6, fontSize: 13, color: "#166534", textAlign: "center" }}>
          Todo en orden. Sin alertas críticas en este momento.
        </div>
      )}
    </div>
  );
  ...
  return (
    <>
      ...
      <div>
        ...
        {tab === "prospeccion" && (
          <div style={{ flex: 1, overflow: "hidden", height: "calc(100vh - 56px)" }}>
            <LogiFlowApp />
          </div>
        )}
        ...
        {tab === "pnr" && <ModuloPNR />}
        {tab === "drivers" && <ModuloDriversMX />}
        {tab === "pagos" && <ModuloPagos />}
        {tab === "config_pagos" && <ModuloConfigPagos />}
      </div>
    </>
  );
}
