...
const MODULOS = {
  superadmin: ["prospeccion", "certificaciones", "wiki", "checklist", "kpis", "maestro", "incidencias", "configuracion"],
  certificacion: ["certificaciones"],
};
const MODULOS_LABELS = {
  certificaciones: "Certificaciones", prospeccion: "Prospección CRM", wiki: "Wiki y Procesos",
  checklist: "Checklist", kpis: "KPIs",
  maestro: "Maestro Operaciones", incidencias: "🚨 Incidencias", configuracion: "Configuración",
};
const USUARIOS = {
...
export default function App() {
  ...
  const [tab, setTab] = useState("prospeccion");
